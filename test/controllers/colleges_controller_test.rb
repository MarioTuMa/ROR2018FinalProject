...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { name: @college.name, private: @college.private } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { name: @college.name, private: @college.private } }
